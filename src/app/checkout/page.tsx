  ...
  return (
    <div className="bg-background pt-32 pb-24 min-h-screen flex items-center justify-center">
      <div className="text-center max-w-md mx-auto px-6">
        ...
        <Link href="/" className="inline-block bg-primary-gold text-white px-8 py-4 uppercase tracking-widest text-xs font-sans hover:bg-primary-dark transition-colors">
          Return to Boutique
        </Link>
      </div>
    </div>
